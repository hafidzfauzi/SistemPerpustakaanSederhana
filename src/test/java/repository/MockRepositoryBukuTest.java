...
class MockRepositoryBukuTest {
    ...
    @BeforeEach
    void setUp() {
        // Setup mock repository sebelum setiap test
        mockRepository = new MockRepositoryBuku();

        // Setup sample data
        buku1 = new Buku("1234567890", "Pemrograman Java", "John Doe", 5, 150000.0);
        buku2 = new Buku("0987654321", "Algoritma dan Struktur Data", "Jane Smith", 3, 180000.0);
    ...
    void testSimpanBukuNull() {
        ...
        assertEquals(0, mockRepository.ukuran(), "Repository tetap kosong");
    }
    ...
    void testSimpanBukuDenganIsbnNull() {
        ...
        bukuInvalid.setJudul("Buku Tanpa ISBN");
    ...
    void testSimpanBukuDuplikat() {
        ...
        // Buat buku updated dengan ISBN sama tapi data berbeda
        Buku bukuUpdated = new Buku("1234567890", "Java Programming Updated", "John Updated", 5, 200000.0);
        ...
        assertEquals(1, mockRepository.ukuran(), "Repository tetap berisi 1 buku");
    ...
    void testCariBukuByIsbnDitemukan() {
        // Arrange
        mockRepository.simpan(buku1);
    ...
    void testCariBukuByIsbnTidakDitemukan() {
        // Arrange
        mockRepository.simpan(buku1);
    ...
    void testHapusBukuYangAda() {
        ...
        assertFalse(mockRepository.mengandung("1234567890"), "Buku sudah dihapus");
