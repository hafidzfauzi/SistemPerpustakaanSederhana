...
import org.example.repository.RepositoryBuku;
import org.example.service.KalkulatorDenda;
import org.example.service.ServicePerpustakaan;
...
@DisplayName("Class ServicePerpustakaanTest")
class ServicePerpustakaanTest {
    ...
    @Test
    @DisplayName("Hapus buku gagal ada yang dipinjam")
    ...
    void testCariBukuByIsbnBerhasil() {
        ...
        // Act
        Optional<Buku> buku = servicePerpustakaan.cariBukuByIsbn("1234567890");

        // Assert
        assertTrue(buku.isPresent(), "Harus menemukan buku");
        assertEquals(bukuTest, buku.get());
        verify(mockRepositoryBuku).cariByIsbn("1234567890");
    }
    ...
    void testCariBukuByJudulBerhasil() {
        // Arrange
        List<Buku> daftarBuku = Collections.singletonList(bukuTest);
        ...
        assertEquals(bukuTest, hasil.getFirst());
    ...
    void testPinjamBukuGagalTidakAktif() {
        // Arrange
    ...
    void testBukuTersedia() {
        ...
        // Act
        boolean tersedia = servicePerpustakaan.bukuTersedia("1234567890");
        ...
        // Act
        boolean tidakTersedia = servicePerpustakaan.bukuTersedia("1234567890");

        // Assert
        assertFalse(tidakTersedia);
    }
